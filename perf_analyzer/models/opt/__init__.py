...
class OPTForCausalLM(NodeMixin):
  # Constructor
  def __init__(self, config: OPTConfig):
    ...
    self.layers = list(
      [OPTDecoderLayer(config, layer_idx, parent=self) for layer_idx in range(config.num_hidden_layers)]
    )
...
class OPTDecoderLayer(NodeMixin):
  # Constructor
  def __init__(self, config: OPTConfig, layer_idx: int, name=None, parent=None):
