...
class FalconForCausalLM(NodeMixin):
  # Constructor
  def __init__(self, config: FalconConfig):
    super(FalconForCausalLM, self).__init__()
    # Config
    self.config = config
    ...
    self.layers = list(
      [FalconDecoderLayer(config, layer_idx, parent=self) for layer_idx in range(config.num_hidden_layers)]
    )
...
class FalconDecoderLayer(NodeMixin):
  # Constructor
  def __init__(self, config: FalconConfig, layer_idx: int, name=None, parent=None):
