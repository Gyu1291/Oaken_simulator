...
class GemmaForCausalLM(NodeMixin):
  # Constructor
  def __init__(self, config: GemmaConfig):
    ...
    self.layers = list(
      [GemmaDecoderLayer(config, layer_idx, parent=self) for layer_idx in range(config.num_hidden_layers)]
    )
...
class GemmaDecoderLayer(NodeMixin):
  # Constructor
  def __init__(self, config: GemmaConfig, layer_idx: int, name=None, parent=None):
    # Config
    self.config = config
