...
class LlamaForCausalLM(NodeMixin):
  # Constructor
  def __init__(self, config: LlamaConfig):
    ...
    self.layers = list(
      [LlamaDecoderLayer(config, layer_idx, parent=self) for layer_idx in range(config.num_hidden_layers)]
    )
...
class LlamaDecoderLayer(NodeMixin):
  # Constructor
  def __init__(self, config: LlamaConfig, layer_idx: int, name=None, parent=None):
