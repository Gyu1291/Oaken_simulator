...
class Qwen2ForCausalLM(NodeMixin):
  # Constructor
  def __init__(self, config: Qwen2Config):
    ...
    self.layers = list(
      [Qwen2DecoderLayer(config, layer_idx, parent=self) for layer_idx in range(config.num_hidden_layers)]
    )
...
class Qwen2DecoderLayer(NodeMixin):
  # Constructor
  def __init__(self, config: Qwen2Config, layer_idx: int, name=None, parent=None):
